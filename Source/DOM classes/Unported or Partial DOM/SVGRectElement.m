...
void SVGKitCGPathAddRoundedRect (CGMutablePathRef path, CGRect rect, CGFloat radiusX, CGFloat radiusY);
...
- (void)postProcessAttributesAddingErrorsTo:(SVGKParseResult *)parseResult {
	...
	else
	{
		...
		SVGKitCGPathAddRoundedRect(path, rect, radiusXPixels, radiusYPixels);
	}
